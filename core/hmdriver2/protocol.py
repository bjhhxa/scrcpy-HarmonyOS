...
KeyMap = {
    ...
    'y': [KeyCode.Y],
    'z': [KeyCode.Z],
    'A': [KeyCode.SHIFT_LEFT, KeyCode.A],
    'B': [KeyCode.SHIFT_LEFT, KeyCode.B],
    'C': [KeyCode.SHIFT_LEFT, KeyCode.C],
    'D': [KeyCode.SHIFT_LEFT, KeyCode.D],
    'E': [KeyCode.SHIFT_LEFT, KeyCode.E],
    'F': [KeyCode.SHIFT_LEFT, KeyCode.F],
    'G': [KeyCode.SHIFT_LEFT, KeyCode.G],
    'H': [KeyCode.SHIFT_LEFT, KeyCode.H],
    'I': [KeyCode.SHIFT_LEFT, KeyCode.I],
    'J': [KeyCode.SHIFT_LEFT, KeyCode.J],
    'K': [KeyCode.SHIFT_LEFT, KeyCode.K],
    'L': [KeyCode.SHIFT_LEFT, KeyCode.L],
    'M': [KeyCode.SHIFT_LEFT, KeyCode.M],
    'N': [KeyCode.SHIFT_LEFT, KeyCode.N],
    'O': [KeyCode.SHIFT_LEFT, KeyCode.O],
    'P': [KeyCode.SHIFT_LEFT, KeyCode.P],
    'Q': [KeyCode.SHIFT_LEFT, KeyCode.Q],
    'R': [KeyCode.SHIFT_LEFT, KeyCode.R],
    'S': [KeyCode.SHIFT_LEFT, KeyCode.S],
    'T': [KeyCode.SHIFT_LEFT, KeyCode.T],
    'U': [KeyCode.SHIFT_LEFT, KeyCode.U],
    'V': [KeyCode.SHIFT_LEFT, KeyCode.V],
    'W': [KeyCode.SHIFT_LEFT, KeyCode.W],
    'X': [KeyCode.SHIFT_LEFT, KeyCode.X],
    'Y': [KeyCode.SHIFT_LEFT, KeyCode.Y],
    'Z': [KeyCode.SHIFT_LEFT, KeyCode.Z],
    ' ': [KeyCode.SPACE],
    'Enter': [KeyCode.ENTER],
    ...
    'Tab': [KeyCode.TAB],
    'Backspace': [KeyCode.DEL], # 删除键
    '`': [KeyCode.GRAVE],   # 按键’`’
    '-': [KeyCode.MINUS],   # 按键’-’
    '=': [KeyCode.EQUALS],   # 按键’=’
    '[': [KeyCode.LEFT_BRACKET],   # 按键’[’
    ']': [KeyCode.RIGHT_BRACKET],   # 按键’]’
    '\\': [KeyCode.BACKSLASH],   # 按键’\’
    ';': [KeyCode.SEMICOLON],  # 按键’;’
    '\'': [KeyCode.APOSTROPHE],   # 按键’‘’(单引号)
    ',': [KeyCode.COMMA],   # 按键’,’
    '.': [KeyCode.PERIOD],   # 按键’.’
    '/': [KeyCode.SLASH],   # 按键’/’
    '~':[KeyCode.SHIFT_LEFT, KeyCode.GRAVE],
    '!':[KeyCode.SHIFT_LEFT, KeyCode.NUM_1],
    '@':[KeyCode.SHIFT_LEFT, KeyCode.NUM_2],
    '#':[KeyCode.SHIFT_LEFT, KeyCode.NUM_3],
    '$':[KeyCode.SHIFT_LEFT, KeyCode.NUM_4],
    '%':[KeyCode.SHIFT_LEFT, KeyCode.NUM_5],
    '^':[KeyCode.SHIFT_LEFT, KeyCode.NUM_6],
    '&':[KeyCode.SHIFT_LEFT, KeyCode.NUM_7],
    '*':[KeyCode.SHIFT_LEFT, KeyCode.NUM_8],
    '(':[KeyCode.SHIFT_LEFT, KeyCode.NUM_9],
    ')':[KeyCode.SHIFT_LEFT, KeyCode.NUM_0],
    '_':[KeyCode.SHIFT_LEFT, KeyCode.MINUS],
    '+':[KeyCode.SHIFT_LEFT, KeyCode.EQUALS],
    '{':[KeyCode.SHIFT_LEFT, KeyCode.LEFT_BRACKET],
    '}':[KeyCode.SHIFT_LEFT, KeyCode.RIGHT_BRACKET],
    '|':[KeyCode.SHIFT_LEFT, KeyCode.BACKSLASH],
    ':':[KeyCode.SHIFT_LEFT, KeyCode.SEMICOLON],
    '"':[KeyCode.SHIFT_LEFT, KeyCode.APOSTROPHE],
    '?':[KeyCode.SHIFT_LEFT, KeyCode.SLASH],
    '<':[KeyCode.SHIFT_LEFT, KeyCode.COMMA],
    '>':[KeyCode.SHIFT_LEFT, KeyCode.PERIOD],
}